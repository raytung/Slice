...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'deal_deal', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['deal.Category']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deal.category'
        db.delete_column(u'deal_deal', 'category_id')
    ...
    models = {
        ...
        u'deal.deal': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['deal.Category']"}),
