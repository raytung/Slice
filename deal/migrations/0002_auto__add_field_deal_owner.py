...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deal.owner'
        db.add_column(u'deal_deal', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=3, to=orm['UserProfile.Profile']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deal.owner'
        db.delete_column(u'deal_deal', 'owner_id')
